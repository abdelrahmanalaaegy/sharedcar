export const LOCS = [
    "أكتوبر", "الشيخ زايد", "القرية الذكية", "حدائق أكتوبر", "حدائق الأهرام", 
    "الهرم", "فيصل", "أرض اللواء", "ميدان لبنان", "المهندسين", "الدقي", 
    "الكيت كات", "إمبابة", "المعادي", "زهراء المعادي", "المقطم", "المنيل", 
    "جاردن سيتي", "مصر القديمة", "وسط البلد ومحيطها", "حلوان", "البدرشين", 
    "شبرا مصر", "الساحل", "شبرا الخيمة", "مدينة نصر", "مصر الجديدة", 
    "المطرية", "عين شمس", "المرج", "المرج الجديدة", "جسر السويس", "النزهة", 
    "التجمع الأول", "التجمع الثالث", "التجمع الخامس", "كايرو فيستيفال", 
    "أكاديمية الشرطة", "الجامعة الأمريكية", "الشروق", "مدينة بدر", "العبور", 
    "العاشر من رمضان", "العاصمة الإدارية"
];
